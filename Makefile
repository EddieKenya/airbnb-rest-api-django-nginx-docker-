ifneq (,$(wildcard ./millionaire))
include ./millionaire/.env
export
ENV_FILE_PARAM = --env-file ./millionaire/.env
endif
...
estate-db:
	docker compose exec postgres-db psql --username=admin --dbname=airbnb
